...
<div class="biggerParagraph">
  "I don't advocate for a world without AI, I call for a world where AI is used
  responsibly." ― Abhijit Naskar, [Visvavictor: Kanima
  Akiyor Kainat](https://www.goodreads.com/work/quotes/170542933-visvavictor-kanima-akiyor-kainat)
</div>
...
<sup>
  Graphical abstract of the journal paper "Understanding oxidation of Fe-Cr-Al
  alloys through explainable artificial intelligence"
</sup>
...
<sup>
  Relationship between experimental tomography data, cell model and computation
  of electrochemical data in battery systems.
</sup>
...
<sup>
  Graphical abstract of the journal paper "Machine learning with knowledge
  constraints for process optimization of open-air perovskite solar cell
  manufacturing"
</sup>
...
<sup>
  Graphical abstract of the journal paper "Prediction of the specific heat of
  polymers from experimental data and machine learning methods"
</sup>
...
<iframe
  src="https://www.youtube.com/embed/cWTWHhMAu7I"
...
<br></br>
<sup>
  TU Delft - Researchers design new material by using Artificial Intelligence
  only.
</sup>
...
<sup>
  Sketch diagram of the neural network used for prediction of structural
  parameters.
</sup>
