...
duration: "8 Min Read"
cover: "./how-to-make-chemical-synthesis-easier-using-ai.png"
...
<div class="biggerParagraph">
  ...
  question of whether a submarine can swim.” — [Edsger W.
...
<sup>
  **Figure 3:** Available registration options (A) and Registering with Google
  (B)
</sup>
...
<img
  src={MoleculeKetcherInterface.src}
  alt="Drawing molecules using Ketcher drawing interface"
/>
<br></br>
...
<img src={moleculesSMILES.src} alt="Loading molecule using SMILES code" />
<br></br>
...
<img
  src={ExportPDFCollection.src}
  alt="Considering all results, exporting one sequence as PDF format and adding one or more sequences to the collection"
/>
<br></br>

<sup>
  **Figure 11:** Considering all results, exporting one sequence as PDF format
  and adding one or more sequences to the collection
</sup>
...
<img src={DrawingReactants.src} alt="Drawing Reactants" />
<br></br>
...
<sup>
  **Figure 14:** Starting new reaction (A), Running prediction (B) and Running
  the prediction process (C and D)
</sup>
...
<img src={AllPredictions.src} alt="Studying all predictions" />
<br></br>
