...
qualitative, chemistry is fundamentally quantitative...</h6>
    ...
    <div class="refRight">
      <p>
      ![Spartan Part 1](./spartan-part-3.png)
      </p>
   </div>
  </div>
</a>
...
href="/tutorial/blogs/2020/basic-introduction-to-computational-chemistry-tools-spartan-part-2">
  ...
  <div class="refContainer">
    ...
    <div class="refRight">
      <p>
      ![Spartan Part 2](./spartan-part-3.png)
      </p>
   </div>
  </div>
</a>
...
![Different properties value for Phenol molecule after using PM3 semi-empirical method ](./figures/different-properties-for-phenol.webp)
...
<img
  src={DiffProperties.src}
  alt="Different properties value studying procedure"
/>
<br></br>
...
<img src={DifferentSurface.src} alt="Different types of surface in Sparta" />
<br></br>
...
<img src={SpectralPlots.src} alt="Getting spectral plots" />
<br></br>
...
<img src={EntireKinetic.src} alt="The entire kinetics study process" />
<br></br>
