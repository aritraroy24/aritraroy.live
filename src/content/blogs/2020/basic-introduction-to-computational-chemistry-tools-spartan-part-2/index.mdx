...
<img src={BondDistanceMeasure.src} alt="Bond distance measurement procedure" />
<br></br>
...
<img src={BondAngleMeasure.src} alt="Bond angle measurement procedure" />
<br></br>
...
<img src={BondDihedralMeasure.src} alt="Dihedral angle measurement procedure" />
<br></br>
...
<img
  src={BondDistanceConstrain.src}
  alt="Bond distance constraining procedure"
/>
<br></br>
...
<img src={BondAngleConstrain.src} alt="Bond angle constraining procedure" />
<br></br>
...
<img
  src={BondDihedralConstrain.src}
  alt="Bond dihedral constraining procedure"
/>
<br></br>
...
<img
  src={Cyclobutane.src}
  alt="Cyclobutane normal structure and point group (2.7.1) and Cyclobutane restricted structure and point group (2.7.2)"
/>
<br></br>

<sup>
  **Figure 2.7:** Cyclobutane normal structure and point group (2.7.1) and
  Cyclobutane restricted structure and point group (2.7.2)
</sup>
...
<img
  src={Coronene.src}
  alt="Methyl substituted coronene normal structure and point group (2.8.1) and Methyl substituted coronene restricted structure and point group (2.8.2)"
/>
<br></br>

<sup>
  **Figure 2.8:** Methyl substituted coronene normal structure and point group
  (2.8.1) and Methyl substituted coronene restricted structure and point group
  (2.8.2)
</sup>
...
<img
  src={Kekulene.src}
  alt="Methyl substituted kekulene normal structure and point group (2.9.1) and Methyl substituted kekulene restricted structure and point group (2.9.2)"
/>
<br></br>

<sup>
  **Figure 2.9:** Methyl substituted kekulene normal structure and point group
  (2.9.1) and Methyl substituted kekulene restricted structure and point group
  (2.9.2)
</sup>
