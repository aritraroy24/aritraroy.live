...
<div class="biggerParagraph">Sample code given by Google Client</div>
...
<sup>
  **Figure 9:** Fetched different folder and contact headings printed on the
  Powershell screen
</sup>
...
<div class="biggerParagraph">Code to retrieve Email and Phone No.</div>
...
<sup>
  **Figure 10:** Fetched names, email ids, phone numbers associated with that
