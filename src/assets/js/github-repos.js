...
async function fetchGitHubRepos() {
    ...
    try {
        ...
        const repoCards = await Promise.all(repoCardPromises);

        // Build fragment and render all at once
        const fragment = document.createDocumentFragment();
        repoCards.forEach(card => fragment.appendChild(card));

        // Hide loader and append fragment
        loader.style.display = 'none';
        container.innerHTML = '';
